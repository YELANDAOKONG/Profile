...
public sealed class UserIdentityTests
{
    ...
    public void Constructor_WithGuid_PreservesValue()
    {
        ...
        var identity = new UserIdentity(value);
    ...
    public void Constructor_WithSameGuid_CreatesEqualIdentities()
    {
        ...
        var first = new UserIdentity(value);
        var second = new UserIdentity(value);
