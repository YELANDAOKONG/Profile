...
public sealed class MomentCommentLikeTests
{
    ...
    public void Create_WithEligibleComment_PreservesRelationship()
    {
        ...
        var commentId = MomentCommentIdentity.New();

        var like = MomentCommentLike.Create(
            likerId,
            commentId,
        ...
        Assert.Equal(commentId, like.MomentCommentId);
    ...
    public void Constructor_ForReconstitution_PreservesRelationship()
    {
        ...
        var like = new MomentCommentLike(likerId, commentId, _likedAt);
