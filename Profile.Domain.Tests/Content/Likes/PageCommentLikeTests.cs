...
public sealed class PageCommentLikeTests
{
    ...
    public void Create_WithEligibleComment_PreservesRelationship()
    {
        ...
        var commentId = PageCommentIdentity.New();

        var like = PageCommentLike.Create(
            likerId,
            commentId,
        ...
        Assert.Equal(commentId, like.PageCommentId);
    ...
    public void Constructor_ForReconstitution_PreservesRelationship()
    {
        ...
        var like = new PageCommentLike(likerId, commentId, _likedAt);
