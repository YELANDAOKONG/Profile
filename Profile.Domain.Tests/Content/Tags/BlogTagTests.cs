...
public sealed class BlogTagTests
{
    ...
    public void ChangeRouteIdentifier_WithSubstantiveChange_ReturnsReservationAndReplacesRoute()
    {
        ...
        Assert.Equal(
            changedAt.Add(BlogTagRouteReservation.DefaultReservationPeriod),
    ...
    {
        var description = new string('a', BlogTag.MaximumDescriptionLength + 1);
    ...
    {
        var seoTitle = new string('a', BlogTag.MaximumSeoTitleLength + 1);
    ...
    private static BlogTag CreateTag(
