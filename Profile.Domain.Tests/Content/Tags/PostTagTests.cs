...
public sealed class PostTagTests
{
    ...
    public void ChangeRouteIdentifier_WithSubstantiveChange_ReturnsReservationAndReplacesRoute()
    {
        ...
        Assert.Equal(
            changedAt.Add(PostTagRouteReservation.DefaultReservationPeriod),
    ...
    {
        var description = new string('a', PostTag.MaximumDescriptionLength + 1);
    ...
    {
        var seoTitle = new string('a', PostTag.MaximumSeoTitleLength + 1);
