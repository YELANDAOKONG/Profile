...
public sealed class MomentIdentityTests
{
    [Fact]
    public void Constructor_WithValidGuid_PreservesValue()
    {
        ...
        var identity = new MomentIdentity(value);
    ...
    {
        var identity = MomentIdentity.New();
    ...
    public void Equality_WithSameGuid_TreatsValuesAsSameIdentity()
    {
        ...
        Assert.Equal(new MomentIdentity(value), new MomentIdentity(value));
    }
}
