...
public sealed class PostTag
{
    ...
    public static PostTag Reconstitute(
        PostTagIdentity id,
        UserIdentity ownerId,
        TaxonomyName name,
        TaxonomyRouteIdentifier routeIdentifier,
    ...
    public PostTagRouteReservation? ChangeRouteIdentifier(
        TaxonomyRouteIdentifier routeIdentifier,
        DateTimeOffset changedAt) =>
        ChangeRouteIdentifier(
            routeIdentifier,
            changedAt,
            PostTagRouteReservation.DefaultReservationPeriod);
