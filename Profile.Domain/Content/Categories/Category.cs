...
{
    public const int MaximumCountPerAccount = 2_048;
    ...
    public CategoryIdentity Id { get; }
    ...
    public CategoryRouteReservation? ChangeRouteIdentifier(
        TaxonomyRouteIdentifier routeIdentifier,
        DateTimeOffset changedAt) =>
        ChangeRouteIdentifier(
            routeIdentifier,
            changedAt,
            CategoryRouteReservation.DefaultReservationPeriod);
